...
TRANSLATIONS: dict = {
    ...
    "new_item.box_weight": {"en": "Weight (kg)", "lv": "Svars (kg)"},
    ...
    "new_item.box_dimension_placeholder": {"en": "cm", "lv": "cm"},
    "product_list.status_draft": {"en": "Draft", "lv": "Melnraksts"},
    "product_list.status_in_progress": {"en": "In Progress", "lv": "Procesā"},
    "product_list.status_completed": {"en": "Completed", "lv": "Pabeigts"},
    "product_list.shelf_label": {"en": "Shelf", "lv": "Plaukts"},
    "product_list.integrations_dialog_title": {"en": "Integrations", "lv": "Integrācijas"},
    "product_list.integrations_none": {
        "en": "This product isn't listed on any integration yet.",
        "lv": "Šis produkts vēl nav nevienā integrācijā.",
    },
    ...
    "product_list.sync_push_failed": {"en": "Saved locally, but pushing the change to {integration} failed: {error}", "lv": "Saglabāts lokāli, bet izmaiņu nosūtīšana uz {integration} neizdevās: {error}"},
    "product_list.weight_kg": {"en": "Weight (kg)", "lv": "Svars (kg)"},
    ...
    "table_col.product": {"en": "Product Name", "lv": "Produkta nosaukums"},
    "table_col.integrations": {"en": "Integration", "lv": "Integrācija"},
    "table_col.brand": {"en": "Brand", "lv": "Zīmols"},
    "table_col.quantity": {"en": "Stock", "lv": "Krājumi"},
    "table_col.price": {"en": "Price", "lv": "Cena"},
    "table_col.weight_kg": {"en": "Weight (kg)", "lv": "Svars (kg)"},
